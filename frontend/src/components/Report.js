    ...
    <div className="report-container">
      ...
      <div className="report-header">
        <div className="candidate-info">
          ...
          <p><strong>⏱️ Duration:</strong> {report.duration ? `${Math.floor(report.duration / 60)} minutes` : 'Ongoing'}</p>
        </div>
        ...
        <div className="integrity-score">
          ...
          <div className="score-breakdown">
            ...
            <p>⚠️ Suspicious Events: -{(report.suspiciousEvents || 0) * 10} points</p>
          </div>
        </div>
      </div>
      ...
      <div className="report-summary">
        ...
        <div className="summary-grid">
          ...
          <div className="summary-item">
            <span className="label">⚠️ Suspicious Events:</span>
            ...
            report.events.map((event, index) => (
              <div key={index} className="timeline-event">
                ...
                <div className={`event-content severity-${event.severity || 'medium'}`}>
                  ...
                  {event.duration && <p>⏱️ Duration: {event.duration}s</p>}
